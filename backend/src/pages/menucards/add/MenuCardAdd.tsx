...
const MenuCardAdd = () => {
  ...
  const menuCardAddHandler = () => {
    ...
    formData.append("thumb_icon", addMenuCardData.thumb_icon);
    formData.append("name", addMenuCardData.name);
  ...
  const exchageNameHandler = (e: any) => {
    ...
    setAddMenuCard({ ...addMenuCardData, name: e });
  };
      ...
      <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
        ...
        >
          <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
            ...
            <InputText
              placeholder="Enter MenuCard Name"
          ...
          <Grid item xl={12} lg={12} md={12} sm={12} xs={12} pt={3}>
            ...
            <InputText
              placeholder="Enter MenuCard url"
