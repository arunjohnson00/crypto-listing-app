  ...
  return (
    <Fragment>
      <Grid container spacing={2}>
        ...
        <Grid item xl={3.5} lg={3.5} md={3.5} sm={12} xs={12} mb={2}>
          <Typography
            sx={{
              textAlign: "left",
              fontWeight: 500,
      ...
      <Grid container spacing={2} alignItems="flex-start">
        <Grid item xl={4} lg={4} md={6} sm={12} xs={12}>
          <Item>
            <Box pt={3}>
              <LineChart
                lineChartData={coinPerDayListing && coinPerDayListing}
              />
            </Box>
          </Item>
        </Grid>
        <Grid item xl={4} lg={4} md={6} sm={12} xs={12}>
          <Item>
            <Box pt={3}>
              ...
              <PieChart
                piData={coinStatusCount}
                title="Current status of coin"
              />
              <ComponentFooter
                data={coinStatusCount}
