        ...
        >
          <Grid item xl={10} lg={10} md={10} sm={12} xs={12}>
            ...
            >
              ...
              <Grid item xl={10} lg={10} md={10} sm={12} xs={12}>
                <InputSearch
                  placeholder="Search Ads Configure Settings"
          ...
          >
            <Link to="/ads-config-settings" style={{ textDecoration: "none" }}>
              <LargeBtn Title="Configuration Settings" width={250} />
            </Link>
          </Grid>
        </Stack>
      </Grid>
...
export default AdsConfigurationListing;
