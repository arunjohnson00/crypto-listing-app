            ...
            {location?.pathname?.replace(/[^a-zA-Z ]/g, "") === "coins" && (
              ...
              >
                ...
                <Stack direction="row" spacing={1}>
                  ...
                  <Box sx={{ minWidth: 150, maxWidth: 150 }}>
                    <Typography
                      ...
                      sx={{ textAlign: "left", color: "#FFFFFF" }}
                    >
                      {filteredData[0]["max_supply"] === null ||
                      filteredData[0]["max_supply"] === "" ? (
                        <span
                          style={{
                            color: "red",
                            fontSize: ".8rem",
                ...
                <Stack direction="row" spacing={1}>
                  ...
                  <Box sx={{ minWidth: 150, maxWidth: 150 }}>
                    <Typography
                      ...
                      sx={{ textAlign: "left", color: "#FFFFFF" }}
                    >
                      {filteredData[0]["is_listed_market_cap"] &&
                      parseInt(filteredData[0]["is_listed_market_cap"]) ===
                        1 ? (
                        <span style={{ display: "flex", alignItems: "center" }}>
                          Yes
                          <Typography
                ...
                <Stack direction="row" spacing={1}>
                  ...
                  <Box sx={{ minWidth: 150, maxWidth: 150 }}>
                    <Typography
                      ...
                      sx={{ textAlign: "left", color: "#FFFFFF" }}
                    >
                      {filteredData[0]["is_listed_coingecko"] &&
                      parseInt(filteredData[0]["is_listed_coingecko"]) === 1
                        ? "Yes"
                        : "No"}
                    </Typography>
                  </Box>
                ...
                <Stack direction="row" spacing={1}>
                  ...
                  <Box sx={{ minWidth: 150, maxWidth: 0 }}>
                    <Typography
                      variant="body2"
                      sx={{
                        textAlign: "left",
                    ...
                    >
                      {filteredData[0]["address"] && filteredData[0]["address"]}
                    </Typography>
                  </Box>
                </Stack>
                <Stack direction="row" spacing={1}>
                  ...
                  <Box sx={{ minWidth: 150, maxWidth: 0 }}>
                    ...
                    >
                      {filteredData[0]["explorer_link"] &&
                        filteredData[0]["explorer_link"].slice(0, 25)}
                      {"..."}
                      {filteredData[0]["explorer_link"] &&
                        filteredData[0]["explorer_link"].slice(-10)}
                    </Typography>
                  </Box>
                </Stack>
              </Stack>
