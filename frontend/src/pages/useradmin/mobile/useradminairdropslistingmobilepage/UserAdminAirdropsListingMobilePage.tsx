...
import { userAirdropsListRequest } from "../../../../store/action";
import { useNavigate } from "react-router-dom";
import { Helmet } from "react-helmet-async";

const UserAdminAirdropsListingMobilePage = () => {
  ...
  return (
    ...
    >
      <Helmet>
        <title> My Airdrops | CoinXhigh.com</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content=" My Airdrops | CoinXhigh.com" />
...
export default UserAdminAirdropsListingMobilePage;
