    ...
    <Grid container rowSpacing={3}>
      ...
      <Grid item xs={12}>
        <Stack direction="column" spacing={3}>
          <Stack direction="row" spacing={2} alignItems="center">
            <Stack direction="column" spacing={0.3}>
              <Typography sx={{ color: "#FFFFF5", fontSize: ".9rem" }}>
                Hi
                <span style={{ color: "#6FB4B3", fontWeight: 600 }}>
                  {" "}
                  Joseph
                </span>
              </Typography>
          ...
          <Stack direction="column" spacing={2} pt={9} pb={25} pl={5}>
              ...
              >
                ...
                <Stack direction="column" spacing={2}>
                  ...
                  >
                    ...
                    <Stack direction="row" spacing={2}>
                      ...
                      <Stack direction="column" spacing={0}>
                        <Typography
                          sx={{ color: "#FFFFF5", fontSize: ".85rem" }}
                        >
                  ...
                  <Stack direction="column" spacing={2} px={3}>
                    ...
                    >
                      Please send the payment {"(Coin)"} with the converted
                      amount to the address below We currently accept the
                      following crypto:
                    </Typography>
                    <Typography
                      sx={{
