      ...
      >
            ...
            <Stack direction="row" spacing={1.5} sx={{ alignItems: "center" }}>
              ...
              <Stack direction="column" spacing={0}>
                ...
                >
                  ...
                  >
                    {cardData && cardData?.name?.length > 7
                      ? cardData?.name?.slice(0, 7) + "..."
                      : cardData?.name}
                  </Link>
                </Typography>
                <Typography
        ...
        <Grid item xs={12} py={0}>
          ...
          >
            {
              <Fragment>
                {cardData && cardData?.is_presale === 1 ? (
                  <Fragment>
                    {cardData &&
                      moment(new Date(cardData?.presale_date)).isAfter(
                        new Date()
                      ) === true && (
                        <Stack
                          direction="row"
                        ...
                        >
                          ...
                          >
                            {CountDownTimer(
                              moment(new Date(cardData?.presale_date))
                            )}
                          </Typography>
                        </Stack>
                      )}
                    ...
                    {cardData &&
                      moment(new Date()).isBetween(
                        new Date(cardData?.presale_date),
                        ...
                        >
                          ...
                          >
                            {CountDownTimer(
                              moment(new Date(cardData?.presale_end_date))
                            )}
                          </Typography>
                        </Stack>
                      )}
