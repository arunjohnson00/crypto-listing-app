...
import MobileFearAndGreedcard from "../cards/fearandgreedcard/MobileFearAndGreedcard";

const serverAPIUrl = process.env.REACT_APP_API_URL;
const MobileDiscoverLatestCoinPresale = () => {
...
export default MobileDiscoverLatestCoinPresale;
